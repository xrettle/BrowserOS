...
BrowserOS comes with a default LLM provider to test things out. But ou have full control over your AI models! Navigate to `New Tab` page and click on settings to configure your own API keys for various providers.
